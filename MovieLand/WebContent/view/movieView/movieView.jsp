...
<head>
 ...
 <style>
  @IMPORT url("<%=request.getContextPath()%>/css/movieView/movieView.css");
 </style>
...
<jsp:include page="../../main/header.jsp"/>
 ...
 <table class="table2" >
  ...
  <tr>
   ...
   <td><a href="<%=request.getContextPath()%>/movie/view6.do"   class="a">
   <aa class="aa">극비수사</aa> <br />
   스릴러 |한국 <br />
   개봉일 2015-05-18
   </a></td>
   <td><a href="<%=request.getContextPath()%>/movie/view7.do"   class="a">
   <aa class="aa">극비수사</aa> <br />
   스릴러 |한국 <br />
   개봉일 2015-05-18
   </a></td>
   <td><a href="<%=request.getContextPath()%>/movie/view8.do"   class="a">
   <aa class="aa">극비수사</aa> <br />
   스릴러 |한국 <br />
   개봉일 2015-05-18
   </a></td>
